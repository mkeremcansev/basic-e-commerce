@extends('Front.main')
@section('title')
{{ $general->title }} - @lang('keywords.search-results')
@endsection
@section('content')
@if ($data->count() > 0)
<div id="page">
	<main class="bg_gray">
		<div class="bg_white">
			...
			<h5 class="pb-3">@lang('keywords.search-data', ['search'=>$search, 'count'=>$data->count()])</h5>
		...
		<div class="container">
            <div class="row justify-content-center">
				<div class="col-md-5">
					...
					<h5>@lang('keywords.dont-search', ['search'=>$search])</h5>
