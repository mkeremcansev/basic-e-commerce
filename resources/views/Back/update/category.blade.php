        ...
        <div class="page-wrapper">
            <div class="page-titles">
                <div class="d-flex align-items-center">
                    <h5 class="font-medium m-b-0">@lang('keywords.category-create')</h5>
                </div>
            </div>
                                ...
                                <form action="{{ route('Update.category', $category->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="input-field col s12">
                                            ...
                                            <input id="name" name="title" value="{{ $category->title }}" type="text">
                                            <span class="errorMessage">{{ $errors->first('title') }}</span>
                                            <label for="name">@lang('keywords.category-title')</label>
                                        </div>
                                    </div>
