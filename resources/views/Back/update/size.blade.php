        ...
        <div class="page-wrapper">
            <div class="page-titles">
                <div class="d-flex align-items-center">
                    <h5 class="font-medium m-b-0">@lang('keywords.size-create')</h5>
                </div>
            </div>
                                ...
                                <form action="{{ route('Update.size', $size->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="input-field col s12">
                                            ...
                                            <input id="name" name="title" value="{{ $size->title }}" type="text">
                                            <span class="errorMessage">{{ $errors->first('title') }}</span>
                                            <label for="name">@lang('keywords.size-title')</label>
                                        </div>
                                    </div>
